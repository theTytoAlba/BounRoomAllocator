...
public class StudentActivity extends AppCompatActivity {
    ...
    private class GetRoomsTask extends AsyncTask<Void, Void, JSONObject> {
        ...
        protected JSONObject doInBackground(Void... voids) {
            ...
            try {
                ...
                Log.e("StudentActivity", "Failed to establish connection.");
            }
            try {
                ...
                Log.e("StudentActivity", "Error while sending message to server.");
                e.printStackTrace();
            }
            return result;
        }
        ...
        protected void onPostExecute(JSONObject result) {
            if (socket != null) {
                try {
                    ...
                    Log.e("StudentActivity", "Failed to close socket.");
                }
            }
            if (in != null) {
                try {
                    ...
                    Log.e("StudentActivity", "Failed to close input stream.");
                }
            }
            if (out != null) {
                try {
                    ...
                    Log.e("StudentActivity", "Failed to close output stream.");
                }
            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("StudentActivity", "Started app in student mode.");

        progressBar = (ProgressBar) findViewById(R.id.studentActivity_progress);
        refreshIcon = (ImageView) findViewById(R.id.studentActivity_refreshIcon);
    ...
    private void successfulGetBuildings(JSONObject rooms) {
        Log.i("StudentActivity", "Received the rooms. Layout in progress");
        Iterator<?> buildingIterator = rooms.keys();
        LinearLayout roomsContainer = (LinearLayout) findViewById(R.id.studentActivity_buildingContainer);
            ...
            try {
                ...
                while (roomIterator.hasNext()) {
                    ...
                    roomAction.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            Intent intent = new Intent(StudentActivity.this, RoomCalendarActivity.class);
                ...
                e.printStackTrace();
                Log.e("StudentActivity", "Could not handle building object for " + buildingName);
            }
        }
        hideProgress();
    }
